...
$extraHead = '
    ...
    <link rel="stylesheet" href="' . app_url('public_assets/css/map.css') . '?v=20260610-2">
';
...
<div class="map-wrap">
    ...
    <div class="map-analysis">
        <button data-draw="spbu" title="Klik lalu klik di peta untuk menaruh SPBU"><i class="fas fa-gas-pump"></i> SPBU</button>
        <button data-draw="jalan" title="Klik beberapa titik untuk menggambar jalan"><i class="fas fa-road"></i> Jalan</button>
        <button data-draw="kavling" title="Klik titik sudut polygon untuk menggambar kavling"><i class="fas fa-vector-square"></i> Kavling</button>
        <button data-draw="kawasan" title="Gambar polygon kawasan kumuh"><i class="fas fa-draw-polygon"></i> Kawasan</button>
        <button data-draw="rumah" title="Taruh marker rumah ibadah"><i class="fas fa-mosque"></i> Rumah Ibadah</button>
        <button data-draw="warga" title="Taruh marker warga miskin"><i class="fas fa-user"></i> Warga</button>
        <button id="btn-find-spbu" class="map-tool-accent" title="Cari SPBU terdekat dari pusat peta"><i class="fas fa-search-location"></i> SPBU Terdekat</button>
    </div>
    ...
    <div class="map-modal" id="formModal">
        <div class="map-modal-content">
            <div class="modal-header" style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
                <span class="modal-title" id="formModalTitle">Tambah Data</span>
                <button class="modal-close" onclick="closeFormModal()" style="background:none;border:none;color:var(--text-muted);cursor:pointer;font-size:1.3rem;">&times;</button>
            </div>
