...
<head>
    ...
    <link rel="stylesheet" href="<?= app_url('public_assets/css/global.css') ?>?v=20260610-spbu-snackbar">
    <link rel="stylesheet" href="<?= app_url('public_assets/css/panel.css') ?>">
